  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="/FIRST/get_post.php">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST'){
      ...
      if(!$conn){
        ...
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
            <strong>error!</strong>We are facing some Technical issues Your Entry was not submitted successfully we regret the inconvinience caused!
            <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            <span aria-hidden="true">×</span>
            </button>
           </div>';
...
<h1>contact us for your concern</h1>
    <form action="/FIRST/Form_inserting_data.php" method="post">
